...
public class ModConfigScreen {
    ...
    public static Screen createScreen(Screen parent) {
        YetAnotherConfigLib.Builder builder = YetAnotherConfigLib.createBuilder()
                .title(Component.translatable("config.straw_backup_beds.title"))
                .save(ModConfig::save);

        ConfigCategory.Builder general = ConfigCategory.createBuilder()
                .name(Component.translatable("config.straw_backup_beds.category.general"))
    ...
    private static Option<Boolean> createBoolOption(String name, boolean defaultValue, Supplier<Boolean> getter, Consumer<Boolean> setter) {
        return Option.<Boolean>createBuilder()
                .name(Component.translatable("config.straw_backup_beds.option." + name))
                .description(OptionDescription.of(Component.translatable("config.straw_backup_beds.option." + name + ".description")))
