...
import com.evandev.straw_backup_beds.client.ClientConfigSetup;
import com.evandev.straw_backup_beds.compat.NMLCompat;
...
public class StrawBackupBeds {
    ...
    public StrawBackupBeds(IEventBus modEventBus, ModContainer modContainer) {
